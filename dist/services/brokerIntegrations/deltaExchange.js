...
exports.DeltaExchangeBroker = void 0;
const axios_1 = __importDefault(require("axios"));
const crypto_1 = __importDefault(require("crypto"));
const ws_1 = __importDefault(require("ws"));
const baseBroker_1 = require("./baseBroker");
const logger_1 = require("../../utils/logger");
class DeltaExchangeBroker extends baseBroker_1.BaseBroker {
    ...
    async connect() {
        try {
            ...
            logger_1.logger.info('Connected to Delta Exchange');
        }
        catch (error) {
    ...
    async disconnect() {
        ...
        logger_1.logger.info('Disconnected from Delta Exchange');
    }
    async validateCredentials() {
        try {
            ...
            logger_1.logger.error('Delta Exchange credential validation failed:', error);
            return false;
        }
    }
    async getAccountBalance() {
        try {
            ...
            return response.data.result.map((balance) => ({
    ...
    async connectWebSocket() {
        return new Promise((resolve, reject) => {
            ...
            this.wsClient.on('close', () => {
                logger_1.logger.info('Delta Exchange WebSocket disconnected');
                this.wsClient = null;
            });
        });
    }
...
exports.DeltaExchangeBroker = DeltaExchangeBroker;
//# sourceMappingURL=deltaExchange.js.map